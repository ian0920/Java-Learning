...
public class AdventureGame {
    ...
    private static final String GAME_LOCATIONS = """
            road,at the end of the road, W: hill, E:well house,S:valley
    ...
    private void loadLocations (String data){
        ...
        for (String s : data.split("\\R")){
            ...
            Map<Compass, String> nextPlace = loadLocations(parts[2]);
            Location location = new Location(parts[1], nextPlace);
    ...
    private Map<Compass, String> loadLocations (String nextPlace) {
