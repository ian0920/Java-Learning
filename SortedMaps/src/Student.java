...
record Purchase (String courseId, int studentId, double price, int yr, int dateOfYear ){

    public LocalDate purchaseDate(){
        return LocalDate.ofYearDay(yr, dateOfYear);
    }
...
public class Student {
    ...
    public String toString() {
        ...
        return "[%d] : %s ".formatted(id,name, String.join(", ", courseName));
    }
}
